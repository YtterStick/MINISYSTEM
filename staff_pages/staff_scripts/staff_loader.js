                    ...
                    if (data.success) {
                        ...
                        transactions.forEach((transaction) => {
                            ...
                            row.innerHTML = `
                                ...
                                <td>
                                    <button class="edit-btn" ${transaction.payment_status === 'Completed' ? 'disabled' : ''}>Edit</button>
                                    <button class="delete-btn" ${transaction.payment_status === 'Completed' ? 'disabled' : ''}>Delete</button>
                                </td>
                            `;
